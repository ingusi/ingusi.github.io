var size = 0;
var placement = 'point';
function categories_test_submarinecables_3(feature, value, size, resolution, labelText,
...
var style_test_submarinecables_3 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var style = categories_test_submarinecables_3(feature, value, size, resolution, labelText,
