...
var format_test_landingpoints_geopackage_2 = new ol.format.GeoJSON();
var features_test_landingpoints_geopackage_2 = format_test_landingpoints_geopackage_2.readFeatures(json_test_landingpoints_geopackage_2, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_test_landingpoints_geopackage_2 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_test_landingpoints_geopackage_2.addFeatures(features_test_landingpoints_geopackage_2);
var lyr_test_landingpoints_geopackage_2 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_test_landingpoints_geopackage_2, 
                style: style_test_landingpoints_geopackage_2,
                popuplayertitle: 'test_landingpoints_geopackage',
                interactive: true,
                title: '<img src="styles/legend/test_landingpoints_geopackage_2.png" /> test_landingpoints_geopackage'
            });
...
lyr_DarkMatternolabelsretina_0.setVisible(true);lyr_test_counries_1.setVisible(true);lyr_test_landingpoints_geopackage_2.setVisible(true);lyr_test_submarinecables_3.setVisible(true);
var layersList = [lyr_DarkMatternolabelsretina_0,lyr_test_counries_1,lyr_test_landingpoints_geopackage_2,lyr_test_submarinecables_3];
lyr_test_counries_1.set('fieldAliases', {'fid': 'fid', 'continent': 'Kontinent', 'name_de': 'Land', 'anzahl_landepunkte': 'Anzahl Landepunkte', });
lyr_test_landingpoints_geopackage_2.set('fieldAliases', {'fid': 'fid', 'name': 'name', 'cable_count': 'cable_count', });
...
lyr_test_landingpoints_geopackage_2.set('fieldImages', {'fid': 'Hidden', 'name': 'TextEdit', 'cable_count': 'Range', });
...
lyr_test_landingpoints_geopackage_2.set('fieldLabels', {'name': 'inline label - visible with data', 'cable_count': 'inline label - visible with data', });
